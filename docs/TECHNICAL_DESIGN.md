...
- Redis caching, Kafka producers/consumers, inbox tables, and DLQ are deferred to Slice 13C. Celery is excluded. PostgreSQL remains authoritative for jobs and the outbox.
- Milestone 13 is Current. Slice 13A is Complete through Pull Request #19 (`dc19714`). Slice 13B adds the transactional outbox on the current feature branch; Slice 13C remains pending.
