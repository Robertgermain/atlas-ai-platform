...
- Redis caching, transactional outbox, Kafka, consumers, and DLQ are deferred to Slices 13B/13C. Celery is excluded. PostgreSQL remains authoritative.
- Milestone 13 is Current; Slice 13A is implemented locally pending its own PR CI and resulting `main` CI.
