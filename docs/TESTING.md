...
- Local live embedding verification (2026-08-09): `test_live_openai_embedding_dimensions` passed via LangChain OpenAI `text-embedding-3-small` and returned 1536 dimensions. Credentials came from a gitignored `.env` only. The live test remains opt-in and is skipped in normal CI. Milestone 10 remains Current pending PR CI and resulting `main` CI.
