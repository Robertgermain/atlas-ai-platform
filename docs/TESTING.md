...
- Milestone 12 is Complete through Pull Request #17 (`e3412c3`) and calibration Pull Request #18 (`9d5abde`). Milestone 13 is Current.
...
- Settings default remains `coordination_provider=noop` when unset. Slice 13A is locally verified pending its own PR CI and resulting `main` CI. Slice 13B/13C (outbox, Kafka, consumers, DLQ) are not covered yet.
